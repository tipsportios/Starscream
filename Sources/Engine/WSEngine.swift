...
FrameCollectorDelegate, HTTPHandlerDelegate {
    ...
    public func start(request: URLRequest) {
        ...
        mutex.signal()
        transport.connect(url: url, timeout: request.timeoutInterval, certificatePinning: certPinner, clientCredential: clientCredential, socksProxy: socksProxy)
    }
